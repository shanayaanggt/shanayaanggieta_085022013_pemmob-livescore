                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text('Champions League', style: TextStyle(fontSize: 16)),
                        Text("81'",
                    ...
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/psg.png', height: 40),
                        SizedBox(width: 20),
                        RichText(
                          text: TextSpan(
                            style: TextStyle(
                ...
                child: Row(
                  children: [
                    ...
                    FinishedMatchCard(
                      ...
                      date: ' 13 April 2024',
                      team1Logo: 'assets/images/liverpool.png',
                      team2Logo: 'assets/images/arsenal.png',
                      score: '4 : 1',
                    ),
                  ],
                ),
            ...
            ListTile(
              leading: CircleAvatar(
                backgroundImage: AssetImage(
                  'assets/images/kylian.png',
                ),
              ),
              title: Text('Top Player'),
              subtitle: Text('Kylian Mbappe'),
            ),
            SizedBox(height: 20),
            Text(
              'Match Stats',
